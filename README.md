...
🗂 Project Structure
qa-user-onboarding-system/ │ ├── postman/ │ ├── QA-User-Onboarding-System.postman_collection.json │ └── qa-user-onboarding-env.postman_environment.json │ ├── test-cases/ │ └── onboarding_testcases.csv │ └── README.md
